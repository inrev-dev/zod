...
export declare type ZodSwitchCase = [ZodTypeAny, ZodTypeAny];
export interface ZodSwitchDef<Schema extends ZodTypeAny> extends ZodTypeDef {
    switchFn: ((input: any) => Schema | undefined | void) | ((input: any) => Promise<Schema | undefined | void>);
    typeName: ZodFirstPartyTypeKind.ZodSwitch;
}
export declare class ZodSwitch<Schema extends ZodTypeAny> extends ZodType<output<Schema>, ZodSwitchDef<Schema>> {
    _parse(input: ParseInput): ParseReturnType<this["_output"]>;
    static create<Schema extends ZodTypeAny>(switchFn: ((input: any) => Schema | undefined | void) | ((input: any) => Promise<Schema | undefined | void>), params?: RawCreateParams): ZodSwitch<Schema>;
}
...
export declare type ZodFirstPartySchemaTypes = ZodString | ZodNumber | ZodNaN | ZodBigInt | ZodBoolean | ZodDate | ZodUndefined | ZodNull | ZodAny | ZodUnknown | ZodNever | ZodVoid | ZodArray<any, any> | ZodObject<any, any, any> | ZodUnion<any> | ZodDiscriminatedUnion<any, any> | ZodSwitch<any> | ZodIntersection<any, any> | ZodTuple<any, any> | ZodRecord<any, any> | ZodMap<any> | ZodSet<any> | ZodFunction<any, any> | ZodLazy<any> | ZodLiteral<any> | ZodEnum<any> | ZodEffects<any, any, any> | ZodNativeEnum<any> | ZodOptional<any> | ZodNullable<any> | ZodDefault<any> | ZodCatch<any> | ZodPromise<any> | ZodBranded<any, any> | ZodPipeline<any, any>;
...
declare const switchType: typeof ZodSwitch.create;
...
export { anyType as any, arrayType as array, bigIntType as bigint, booleanType as boolean, dateType as date, discriminatedUnionType as discriminatedUnion, effectsType as effect, enumType as enum, functionType as function, instanceOfType as instanceof, intersectionType as intersection, lazyType as lazy, literalType as literal, mapType as map, nanType as nan, nativeEnumType as nativeEnum, neverType as never, nullType as null, nullableType as nullable, numberType as number, objectType as object, oboolean, onumber, optionalType as optional, ostring, pipelineType as pipeline, preprocessType as preprocess, promiseType as promise, recordType as record, setType as set, strictObjectType as strictObject, stringType as string, switchType as switch, symbolType as symbol, effectsType as transformer, tupleType as tuple, undefinedType as undefined, unionType as union, unknownType as unknown, voidType as void, };
