...
const doubleLargeNestedSuite = new benchmark_1.default.Suite("z.union: double large nested");
const manyLargeNestedSuite = new benchmark_1.default.Suite("z.union: many large nested");
...
const doubleLargeNested = index_1.z.union([aLargeNestedSchema, bLargeNestedSchema]);
const many = index_1.z.union([aSchema, bSchema, cSchema, dSchema]);
const manyLargeNested = index_1.z.union([aLargeNestedSchema, bLargeNestedSchema, cLargeNestedSchema, dLargeNestedSchema]);
doubleSuite
    .add("valid: a", () => {
    double.parse(objA);
})
