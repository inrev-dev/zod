...
const doubleLargeNestedSuite = new benchmark_1.default.Suite("z.discriminatedUnion: double large nested");
const manyLargeNestedSuite = new benchmark_1.default.Suite("z.discriminatedUnion: many large nested");
...
const doubleLargeNested = index_1.z.discriminatedUnion("type", [aLargeNestedSchema, bLargeNestedSchema]);
const many = index_1.z.discriminatedUnion("type", [aSchema, bSchema, cSchema, dSchema]);
const manyLargeNested = index_1.z.discriminatedUnion("type", [aLargeNestedSchema, bLargeNestedSchema, cLargeNestedSchema, dLargeNestedSchema]);
doubleSuite
    .add("valid: a", () => {
    double.parse(objA);
})
