...
export declare const ZodIssueCode: {
    ...
    no_switch_case_match: "no_switch_case_match";
...
export interface ZodNoSwitchCaseMatchIssue extends ZodIssueBase {
    code: typeof ZodIssueCode.no_switch_case_match;
}
...
export declare type ZodIssueOptionalMessage = ZodInvalidTypeIssue | ZodInvalidLiteralIssue | ZodUnrecognizedKeysIssue | ZodInvalidUnionIssue | ZodInvalidUnionDiscriminatorIssue | ZodNoSwitchCaseMatchIssue | ZodInvalidEnumValueIssue | ZodInvalidArgumentsIssue | ZodInvalidReturnTypeIssue | ZodInvalidDateIssue | ZodInvalidStringIssue | ZodTooSmallIssue | ZodTooBigIssue | ZodInvalidIntersectionTypesIssue | ZodNotMultipleOfIssue | ZodNotFiniteIssue | ZodCustomIssue;
